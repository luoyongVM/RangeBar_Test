...
public class RangeBar extends View {
    ...
    public void setTickEnd(float tickEnd) {
        //// TODO: 2017/11/19 这是我添加的限定条件，限定间隔值，从而限定tickCount的数量，如果tickCount数量过大，则需要绘制很久，过度绘制容易卡死
//        mTickInterval = calculateTickInterval(tickEnd);
    ...
    private float calculateTickInterval(float tickEnd) {
        if (tickEnd >= 100000000 && tickEnd <= 999999999) {

            return mTickInterval = 100000;

        }
        if (tickEnd >= 10000000 && tickEnd <= 99999999) {

            return mTickInterval =  10000;


        }
        if (tickEnd >= 1000000 && tickEnd <= 9999999) {

            return mTickInterval = 1000;

        }
        if (tickEnd >= 100000 && tickEnd <= 999999) {

            return mTickInterval = 100;

        }
//        if (tickEnd >= 10000 && tickEnd <= 99999) {
//
//            return mTickInterval =  10;
//
//        }
